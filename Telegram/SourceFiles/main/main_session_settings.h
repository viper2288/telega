...
public:
	...
	void setEnterpriseAutoBroadcast(bool enabled) {
		_enterpriseAutoBroadcast = enabled;
	}
	[[nodiscard]] bool enterpriseAutoBroadcast() const {
		return _enterpriseAutoBroadcast;
	}
...
private:
	...
	bool _enterpriseAutoBroadcast = false;
