...
, _saveSettingsTimer([=] { saveSettings(); }) {
	...
	_broadcastService = std::make_unique<Enterprise::BroadcastService>(this);
	_broadcastService->setEnabled(_settings->enterpriseAutoBroadcast());
}

Enterprise::BroadcastService &Session::broadcastService() {
